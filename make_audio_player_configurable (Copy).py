...
# 2. 再生設定のデフォルト値
DEFAULT_CHINESE_SPEED = "1.0"   # 中国語のデフォルト再生速度
DEFAULT_JAPANESE_SPEED = "1.0"  # 日本語のデフォルト再生速度
DEFAULT_REPEAT_COUNT = "4"      # 例文のデフォルト繰り返し回数
